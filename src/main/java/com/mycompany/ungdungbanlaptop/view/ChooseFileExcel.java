 ...
 * @author thang
 */
public class ChooseFileExcel extends javax.swing.JFrame {

   private List<HoaDonRespone> list;
   
    public ChooseFileExcel(List<HoaDonRespone> list) {
        initComponents();
        this.list = list;
    }
    ...
    private void initComponents() {
        ...
        cboDinhDang.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "xlsx", "xls" }));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtTen)
                            .addComponent(cboDinhDang, 0, 263, Short.MAX_VALUE))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(errorTen, javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       if(txtTen.getText().isEmpty()){
           errorTen.setText("Vui lòng nhập tên file");
       }else{
            HoaDonExport.exportData(list,txtTen.getText()+"."+ cboDinhDang.getSelectedItem().toString());
            this.dispose();
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChooseFileExcel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new ChooseFileExcel().setVisible(true);
            }
        });
    }
